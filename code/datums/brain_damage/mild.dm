...
/datum/brain_trauma/mild/dumbness/on_life(seconds_per_tick)
	...
	if(SPT_PROB(1.5, seconds_per_tick))
		...
		owner.say(pick_list_replacements(CRIMSON_BRAIN_DAMAGE_FILE, "brain_damage"), forced = "brain damage", filterproof = TRUE) // CRIMSON EDIT - Drug Fixes - Original: BRAIN_DAMAGE_FILE
