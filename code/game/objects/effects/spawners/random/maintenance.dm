...
/obj/effect/spawner/random/maintenance/proc/get_effective_lootcount()
	...
	if(HAS_TRAIT(SSstation, STATION_TRAIT_FILLED_MAINT))
		effective_lootcount = FLOOR(spawn_loot_count * 1.5, 2) // CRIMSON EDIT CHANGE - Original: effective_lootcount = FLOOR(spawn_loot_count * 1.5, 1)

	else if(HAS_TRAIT(SSstation, STATION_TRAIT_EMPTY_MAINT))
		effective_lootcount = FLOOR(spawn_loot_count * 1.5, 2) // CRIMSON EDIT CHANGE - Original: effective_lootcount = FLOOR(spawn_loot_count * 0.5, 1)
