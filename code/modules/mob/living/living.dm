...
GAME_VERB(/mob/living, succumb, "succumb", whispered as num|null) // CRIMSON EDIT CHANGE ORIGINAL: GAME_VERB_HIDDEN(/mob/living, succumb, "succumb", whispered as num|null)
	if (!CAN_SUCCUMB(src))
