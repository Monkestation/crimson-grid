...
#define DEPARTMENT_BITFLAG_GIOVANNI (1<<9)
#define DEPARTMENT_GIOVANNI "Giovanni"
#define DEPARTMENT_BITFLAG_POLICE (1<<10)
#define DEPARTMENT_POLICE "Police"
#define DEPARTMENT_BITFLAG_SABBAT (1<<11)
#define DEPARTMENT_SABBAT "Sabbat"
#define DEPARTMENT_BITFLAG_CHANTRY (1<<12)
#define DEPARTMENT_CHANTRY "Chantry"
#define DEPARTMENT_BITFLAG_MANOR (1<<13)
#define DEPARTMENT_MANOR "Manor"
#define DEPARTMENT_BITFLAG_CITY_SERVICES (1<<14)
#define DEPARTMENT_CITY_SERVICES "City Services"
#define DEPARTMENT_BITFLAG_PENTEX (1<<15)
#define DEPARTMENT_PENTEX "Pentex"
#define DEPARTMENT_BITFLAG_GAIA (1<<16)
#define DEPARTMENT_GAIA "Garou Nation"
#define DEPARTMENT_BITFLAG_SOCIETY_OF_LEOPOLD (1<<17)
