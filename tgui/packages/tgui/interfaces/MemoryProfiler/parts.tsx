 ...
 */
// `ListCounts`, not `ListsHeader`: every field this reads comes off the walk
// itself, so it renders identically for a census that could not resolve a
// single owner. Widening the prop would drag the attribution half in with it
// and make this unusable on exactly the worlds it matters most on.
