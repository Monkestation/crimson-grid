...
// Crimsn Grid Addition start | Change: Adds the Sheriff's special sword from VTMB to replace the ugly Sheriff'S Special.
/obj/item/sheriffblade/vamp
	...
	icon = 'modular_darkpack/modules/weapons/icons/weapons64x32.dmi'
