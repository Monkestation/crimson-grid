...
/datum/status_effect/potence/on_apply()
	...
	//owner.st_remove_stat_mod(STAT_STRENGTH, "Potence") CRIMSON EDIT REMOVAL - Nerfs on Potence, ...
...
/datum/status_effect/potence/on_remove()
	...
	//owner.st_add_stat_mod(STAT_STRENGTH, level, "Potence") CRIMSON EDIT REMOVAL - Nerfs on Potence, ...
