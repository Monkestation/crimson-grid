...
// CRIMSON EDIT ADD START - Shop Inventories Additions
		...
		new /datum/data/vending_product("wooden planks", /obj/item/stack/sheet/mineral/wood/fifty, 100),
		new /datum/data/vending_product("iron sheets", /obj/item/stack/sheet/iron/fifty, 100),
		new /datum/data/vending_product("glass sheets", /obj/item/stack/sheet/glass/fifty, 100),
		new /datum/data/vending_product("plastic sheets", /obj/item/stack/sheet/plastic/fifty, 120),
		new /datum/data/vending_product("cardboard sheets", /obj/item/stack/sheet/cardboard/fifty, 50),
