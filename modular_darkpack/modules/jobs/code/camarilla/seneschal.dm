/datum/job/vampire/clerk
	...
	known_contacts = list(JOB_PRINCE,JOB_SHERIFF,JOB_TREMERE_REGENT,JOB_DEALER,JOB_EMISSARY,JOB_BARON,JOB_PRIMOGEN_BANU_HAQIM,JOB_PRIMOGEN_TOREADOR,JOB_PRIMOGEN_LASOMBRA,JOB_PRIMOGEN_MALKAVIAN,JOB_PRIMOGEN_VENTRUE,JOB_PRIMOGEN_NOSFERATU)
