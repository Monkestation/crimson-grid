...
/datum/species/human/shifter/war
	...
	inherent_traits = list(
		...
		TRAIT_QUICK_CARRY, //CRIMSON GRID ADDITION
		TRAIT_GOOD_HEARING, //CRIMSON GRID ADDITION
		TRAIT_STRENGTH, //CRIMSON GRID ADDITION
		TRAIT_HATED_BY_DOGS, //CRIMSON GRID ADDITION
		TRAIT_NO_SLIP_WATER, //CRIMSON GRID ADDITION
		TRAIT_HEAD_INJURY_BLOCKED, //CRIMSON GRID ADDITION
		TRAIT_NO_STAGGER, //CRIMSON GRID ADDITION
		TRAIT_BRAWLING_KNOCKDOWN_BLOCKED, //CRIMSON GRID ADDITION
		TRAIT_PUSHIMMUNE, //CRIMSON GRID ADDITION
		TRAIT_FAT_IGNORE_SLOWDOWN, //CRIMSON GRID ADDITION
		TRAIT_BATON_RESISTANCE, //CRIMSON GRID ADDITION
		TRAIT_FEARLESS, //CRIMSON GRID ADDITION
		TRAIT_GRABRESISTANCE, //CRIMSON GRID ADDITION
		TRAIT_HARDLY_WOUNDED, //CRIMSON GRID ADDITION
	)
...
/datum/species/human/shifter/dire
	...
	inherent_traits = list(
		...
		TRAIT_KEEN_NOSE, //CRIMSON GRID ADDITION - Fluff that just lets them smell things
		TRAIT_QUICK_CARRY, //CRIMSON GRID ADDITION
		TRAIT_XRAY_HEARING, //CRIMSON GRID ADDITION
		TRAIT_GOOD_HEARING, //CRIMSON GRID ADDITION
		TRAIT_STRENGTH, //CRIMSON GRID ADDITION
		TRAIT_BATON_RESISTANCE, //CRIMSON GRID ADDITION
		TRAIT_HATED_BY_DOGS, //CRIMSON GRID ADDITION
