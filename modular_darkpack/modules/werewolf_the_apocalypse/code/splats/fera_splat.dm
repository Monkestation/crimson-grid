...
/datum/splat/werewolf/shifter/garou
	...
	transformation_stats = list(
		...
		SPECIES_FERA_WAR = list(
			...
			STAT_STAMINA = 8, // CRIMSON EDIT CHANGE - Original : STAT_STAMINA = 3,
...
/datum/splat/werewolf/shifter/corax
	...
	transformation_stats = list(
		SPECIES_FERA_WAR = list(
			STAT_STRENGTH = 3, // CRIMSON EDIT CHANGE - Original : STAT_STRENGTH = 1,
			STAT_STAMINA = 3, // CRIMSON EDIT CHANGE - Original : STAT_STAMINA = 1,
			STAT_DEXTERITY = 3, // CRIMSON EDIT CHANGE - Original : STAT_DEXTERITY = 1,
			STAT_MANIPULATION = -2,
			STAT_PERCEPTION = 3,
			// STAT_APPEARANCE = 0 // NOT YET SUPPORTED
