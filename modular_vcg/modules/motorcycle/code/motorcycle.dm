...
/datum/looping_sound/motorcycle_engine
	start_sound = 'modular_vcg/modules/motorcycle/sound/bike_idle_start.ogg'
	start_length = 2 SECONDS
	mid_sounds = list('modular_vcg/modules/motorcycle/sound/bike_idle.ogg')
	mid_length = 1.1 SECONDS
	end_sound = 'modular_vcg/modules/motorcycle/sound/bike_idle_kill.ogg'
/*
//Bike Sounds. Could use all of these later. Working on other problems right now.
'modular_vcg/modules/motorcycle/sound/bike_idle_start.ogg'
'modular_vcg/modules/motorcycle/sound/bike_idle.ogg'
'modular_vcg/modules/motorcycle/sound/bike_idle_kill.ogg'
'modular_vcg/modules/motorcycle/sound/bike_idle_rev.ogg'
'modular_vcg/modules/motorcycle/sound/bike_idle_run.ogg'
*/

//Still needs balance approval.
...
/obj/motorcycle
	...
	icon = 'modular_vcg/modules/motorcycle/icons/obj/motorcycle.dmi'
